...
@Database(entities = [Receta::class, Favorito::class, Reciente::class], version = 9) //cambiar de vers si se cambia algo de la db
...
abstract class AppDatabase : RoomDatabase() {
    ...
    abstract fun recienteDao(): RecienteDao
        ...
        fun getDatabase(context: Context): AppDatabase {
            return INSTANCE ?: synchronized(this) {
                ...
                val instance = Room.databaseBuilder(
                    ...
                    .fallbackToDestructiveMigration()  // Esto eliminará la base de datos si modifica el esquema (cambios en entidades..)
                    .build()
